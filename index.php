...
<html lang="es">
    ...
    <body style="background-color: #e4efe7;">
        <nav class="d-flex justify-content-between  " style="background-color: #4054B2" >
            <!--<a href="index.php"><h4 class="p-2 m-2 text-light">LOGO</h4></a> -->
    
            <div>
            <img alt="Unidad Educativa García" 
            data-src="http://unidadeducativagarcia.com/wp-content/uploads/2020/08/Logo-UEP-letras-blancas.png" 
            class=" lazyloaded" src="http://unidadeducativagarcia.com/wp-content/uploads/2020/08/Logo-UEP-letras-blancas.png"
            sizes="(max-width: 400px) 100vw, 400px" width="400" height="60">
            </div>
            <form action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST" class="d-flex flex-row p-1" id="formulario">
                ...
                <input type="submit" class="btn btn3 rounded m-2 " style="background-color:#FFF275;" name="acceder" id="btn" value="Acceder">
            </form>
        </nav> 
        <div class="container">
            <div>
                <h1 class="h4 mb-4 mt-5" align="center"><b>Sistema de Control de Asistencia de los Docentes de la Unidad Educativa García</b></h1>
                ...
                <form class="col-12 mt-5" action="">
                    <div class="row w100"> 
                        <div class="col-12 my-3">
                            <p style="font-size:20px; font-weight:bold; color:#325288;">DIGITE EL CODIGO Y PULSE LA TECLA ENTER</p>
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="input-group mt-2">
                                <span class="input-group-text text-light" id="basic-addon1" style="background-color:#325288;">Codigo de Docente:</span>
