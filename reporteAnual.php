...
<div class="tab-content flex-grow-1 ms-3" id="v-tabs-tabContent">
	<div class='row'>
		<h3 align="center" ><br><b>Reporte por Rango de Fechas</b><br><br></h3>
		...
		<div class="col-sm-4">
			<div class="form-group">
				...
				<div class="col-sm-6">
					...
					<button type="button" class="btn btn-outline-info s" name="buscar" id="buscar"><b>Generar reporte</b></button>
				</div>
			</div>
		</div>
	</div>
