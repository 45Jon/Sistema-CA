...
<div class="tab-content flex-grow-1 ms-3" id="v-tabs-tabContent">
	<div class='row'>
		<!--<h3>Buscar por Empleado y Rango de Fechas</b></h3>  -->
		<h3 align="center"><br><b>Empleado: </b> <?php echo strtoupper($nombre)?><br><br></h3>
		<input type='hidden' value='<?php echo $codigo?>' id='codigo' name='codigo' />
		<!--aqui le pedimos las fechas-->
		<div class="col-sm-4">
			<div class="form-control" align="center">
				<label class="col-sm-4 control-label"><b>Fecha de inicio</b></label>
				<div class="col-sm-4">
		...
		<div class="col-sm-4">
			<div class="form-control" align="center">
				<label class="col-sm-4 control-label"><b>Fecha  Fin</b></label>
				<div class="col-sm-4">
		...
		<div class="col-sm-4">
			<div class="form-group">
				...
				<div class="col-sm-6">
					...
					<button type="button" class="btn btn-outline-info s" name="buscar" id="buscar"><b>Ver</b></button>
				</div>
			</div>
		</div>
	</div>
	<div class='mostrar_datos'>
		<h5><br>Lista de LLegadas por Fechas</h5>
